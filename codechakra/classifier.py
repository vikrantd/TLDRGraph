"""
Layer Classification Engine for CodeChakra.
...
class LayerType(str, Enum):
    ...
    code must use :mod:`codechakra.layers` ids instead.
    """
...
def classify_node(node_id: str, node_data: Dict[str, Any]) -> Layer:
    ...
    Returns the :class:`~codechakra.layers.Layer` from the active registry.
    """
