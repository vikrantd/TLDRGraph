"""
Interactive multi-layer clustered visualizer for CodeChakra.

Module map:

- :mod:`~codechakra.visualizer.palette` - color palette and layer styling config
- :mod:`~codechakra.visualizer.data`    - graph snapshot -> two-tier render payload
- :mod:`~codechakra.visualizer.render`  - inlines payload + assets into one HTML file
