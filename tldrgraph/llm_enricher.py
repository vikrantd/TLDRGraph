"""
LLM Enrichment & Cross-Layer Linker for TLDRGraph.
...
Antigravity) via `tldrgraph queue-enrichment` / `apply-enrichment` -- it can read
...
_PROMPT_TEMPLATE = """You are TLDRGraph, an expert software architecture intelligence engine.
...
PROPOSE_LAYERS_SYSTEM_PROMPT = """You are TLDRGraph, an expert software architecture intelligence engine.
